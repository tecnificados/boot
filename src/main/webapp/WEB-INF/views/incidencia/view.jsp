			...
			<c:otherwise>
				<form class="issueForm">
					<div class="form-group">
						<label for="titulo">Título</label> <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Escribe el título de la incidencia" value="${incidencia.titulo}" readonly="readonly">
					</div>

					<div class="form-group">
						<label for="descripcion">Descripción</label>
						<textarea class="form-control" id="descripcion" name="descripcion" rows="3" readonly="readonly">${incidencia.descripcion}</textarea>
					</div>

					<div class="form-group">
						<label for="estado">Estado</label> <select class="form-control" id="estado" name="estado" disabled="disabled">
					...
					<div class="form-group">
						<label for="autor">Autor</label> <input type="text" class="form-control" id="autor" name="autor" placeholder="Escribe el nombre del usuario que envía la incidencia" value="${incidencia.autor}" readonly="readonly">
					</div>
				</form>
			</c:otherwise>
		</c:choose>
